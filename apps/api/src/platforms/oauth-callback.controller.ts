...
export class OAuthCallbackController {
  ...
  async handleCallback(
    ...
    try {
      ...
      // Step 5 — exchange code for tokens via the platform adapter
      ...
      // Step 7 — encrypt and upsert ConnectedAccount
      const { credential, profile } = exchangeResult.value;
